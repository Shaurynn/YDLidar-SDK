...
def animate(num):
    ...
    if r:
        ...
        # Prevent lines drawing to the origin by neutralizing invalid/zero ranges
        ...
        # 4. Mask out segments that bridge large depth gaps (or touch the origin)
        depth_threshold = 0.2 
        ...
        lc = LineCollection(valid_segments, cmap='hsv', linewidth=4)
